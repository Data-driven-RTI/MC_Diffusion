...
def IoU_RPD(testfile,pretrainmodel):
    ...
    with torch.no_grad():
        ...
        with open("../EvaluationResult_Case3_Moisture.txt","a+",encoding="utf-8") as fe:
            fe.write("RPD:")
            fe.write("\t")
...
if __name__ == "__main__":
    if not os.path.exists("../TestS1E2_S2/"):
        os.mkdir("../TestS1E2_S2/")
    saveValid("../datafiles/TestS1E2_S2.txt","../RecordsFirst/MultiBranchCNN_S1E2_S2.pth","../TestS1E2_S2/")
    changeFile("../datafiles/TestS1E2_S2.txt","../TestS1E2_S2")
    ImageEvaluate("../datafiles/TestS1E2_S2_FirstStage.txt","../RecordsSecond/Second2_2_S1E2_S2.pth","Eh1Em_Eh2")
    IoU_RPD("../datafiles/TestS1E2_S2_FirstStage.txt","../RecordsSecond/Second2_2_S1E2_S2.pth")

    if not os.path.exists("../TestS1S2_E2/"):
        os.mkdir("../TestS1S2_E2/")
    saveValid("../datafiles/TestS1S2_E2.txt","../RecordsFirst/MultiBranchCNN_S1S2_E2.pth","../TestS1S2_E2/")
    changeFile("../datafiles/TestS1S2_E2.txt","../TestS1S2_E2")
    ImageEvaluate("../datafiles/TestS1S2_E2_FirstStage.txt","../RecordsSecond/Second2_2_S1S2_E2.pth","Eh1Eh2_Em")
    IoU_RPD("../datafiles/TestS1S2_E2_FirstStage.txt","../RecordsSecond/Second2_2_S1S2_E2.pth")


    if not os.path.exists("../TestS2E2_S1/"):
        os.mkdir("../TestS2E2_S1/")
    saveValid("../datafiles/TestS2E2_S1.txt","../RecordsFirst/MultiBranchCNN_S2E2_S1.pth","../TestS2E2_S1/")    
    changeFile("../datafiles/TestS2E2_S1.txt","../TestS2E2_S1")
    ImageEvaluate("../datafiles/TestS2E2_S1_FirstStage.txt","../RecordsSecond/Second2_2_S2E2_S1.pth","Eh2Em_Eh1")
    IoU_RPD("../datafiles/TestS2E2_S1_FirstStage.txt","../RecordsSecond/Second2_2_S2E2_S1.pth")
